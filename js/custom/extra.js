...
window.addEventListener("DOMContentLoaded", event => {
    var navbarMobile = function () {
        ...
        const HeaderHeight = myHeaderHeight - 91;
        if (!nCollapsible) {
            return;
        }
...
(function () {
    ...
    myMessage.addEventListener("blur", controlMassage);
    ...
    function controlName() {
        ...
        if (myName.value.length == 0) {
            ...
            myError.textContent = "İsim alanı boş bıraklamaz";
            return false;
    ...
    function controlEmail() {
        ...
        if (myEmail.value.length == 0) {
            ...
            myError.textContent = "Eposta alanı boş bıraklamaz";
            return false;
            ...
            return false;
        } else if (myEmail.value.length <11 ) {
            myEmail.classList.remove("is-valid");
            myEmail.classList.add("is-invalid");
            myError.textContent = "Eposta adresiniz minimum 10 karakter olmalıdır ";
            return false;
        } else if (myEmail.value.length >30) {
            myEmail.classList.remove("is-valid");
            myEmail.classList.add("is-invalid");
            myError.textContent = "Eposta adresiniz maksimum 30 karakter olmalıdır ";
            return false;
        }  else {
    ...
    function controlPhone() {
        ...
        if (myPhone.value.length == 0) {
            ...
            myError.textContent = "Telefon alanı boş bıraklımaz";
            return false;
    ...
    function controlMassage() {
        ...
        if (myMessage.value.length == 0) {
            ...
            myError.textContent = "Mesaj alanı boş bıraklımaz";
            return false;
